 ...
 *   <li>{@link xtext.towerDefense.Partie#getPartiesElements <em>Parties Elements</em>}</li>
...
public interface Partie extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>Parties Elements</b></em>' containment reference list.
   * The list contents are of type {@link xtext.towerDefense.PartieElement}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Parties Elements</em>' containment reference list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Parties Elements</em>' containment reference list.
   * @see xtext.towerDefense.TowerDefensePackage#getPartie_PartiesElements()
   * @model containment="true"
   * @generated
   */
  EList<PartieElement> getPartiesElements();
