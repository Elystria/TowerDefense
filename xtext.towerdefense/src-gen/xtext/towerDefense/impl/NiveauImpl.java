 ...
 *   <li>{@link xtext.towerDefense.impl.NiveauImpl#getTerrain <em>Terrain</em>}</li>
...
public class NiveauImpl extends MinimalEObjectImpl.Container implements Niveau
{
   ...
   * @ordered
   */
  protected TerrainDeJeu terrain;
   ...
   * @generated
   */
  public NotificationChain basicSetTerrain(TerrainDeJeu newTerrain, NotificationChain msgs)
  {
    TerrainDeJeu oldTerrain = terrain;
    terrain = newTerrain;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TowerDefensePackage.NIVEAU__TERRAIN, oldTerrain, newTerrain);
   ...
   * @generated
   */
  public void setTerrain(TerrainDeJeu newTerrain)
  {
    if (newTerrain != terrain)
    {
      NotificationChain msgs = null;
      if (terrain != null)
        msgs = ((InternalEObject)terrain).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TowerDefensePackage.NIVEAU__TERRAIN, null, msgs);
      if (newTerrain != null)
        msgs = ((InternalEObject)newTerrain).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TowerDefensePackage.NIVEAU__TERRAIN, null, msgs);
      msgs = basicSetTerrain(newTerrain, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TowerDefensePackage.NIVEAU__TERRAIN, newTerrain, newTerrain));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TowerDefensePackage.NIVEAU__TERRAIN:
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case TowerDefensePackage.NIVEAU__MOB_SORTIS_LIMITE:
        ...
        return;
      case TowerDefensePackage.NIVEAU__TERRAIN:
        setTerrain((TerrainDeJeu)newValue);
        return;
      case TowerDefensePackage.NIVEAU__VAGUES:
        getVagues().clear();
