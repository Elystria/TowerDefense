 ...
 * </p>
 * <ul>
 *   <li>{@link xtext.towerDefense.impl.ProjectileImpl#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public class ProjectileImpl extends MinimalEObjectImpl.Container implements Projectile
{
  /**
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TowerDefensePackage.PROJECTILE__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TowerDefensePackage.PROJECTILE__NAME:
        return getName();
